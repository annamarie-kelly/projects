...
class bug:
	...
	def bug_hit(self, pClick):
		...
		# Consider the bug like a circle with radius 1
		bug_center = self.bug.anchor
		anchor_offset = 0.5
		xc = bug_center.x - 0.5
		yc = bug_center.y + 0.5
...
def main():
	...
	while True:
		...
		# Checking click on start button
			...
			# Generate random x,y AND use balloon class and create BL_list which a list of balloon class objects
